...
function Shimmer() {
  return (
    <>
      <div className="">
            <div className=" animate-pulse relative  p-4 w-full bg-white rounded-lg overflow-hidden shadow hover:shadow-md  ">
              <div className="animate-pulse z-0  flex flex-col">
          ...
          <div className=" animate-pulse p-4 w-full bg-white rounded-lg overflow-hidden shadow hover:shadow-md ">
