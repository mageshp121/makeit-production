...
function Login() {
        ...
        try {
          ...
          if (res.status === 200) {
            if (res.data.userObject.roll === "user") {
              ...
              console.log("registerd as tutor");
              UseAuth(
                "This account is associated with a tutor...! Please login as a tutor"
              );
              // navigate("/tutor/login");
            }
  ...
  return (
    <>
      ...
      {errorMessage && (
        <ErrorComponent data={{ path: "/auth", Message: errorMessage }} />
      )}
            ...
            <div className="flex flex-col items-center mt-4">
              ...
              <div className="flex-1 w-full ">
                <div className="flex flex-col items-center">
                  <button
                    onClick={() => googleSignInUser(authentication)}
                ...
                <div className="max-w-xs mx-auto">
                  ...
                  <p className="mt-6 text-xs text-center text-gray-600">
                    ...
                    <Link replace={true} to={"/tutor/login"}>
